<template>
	<view>
		<view :id="elId" class="v-tabs" style="position: fixed;zIndex: 1993;width: 100%;padding: 35rpx 28rpx;background: #ffffff;">
		  <scroll-view
		    id="scrollContainer"
		    :scroll-x="scroll"
		    :scroll-left="scroll ? scrollLeft : 0"
		    :scroll-with-animation="scroll"
		    :style="{ borderRadius: '18rpx',overflow: 'hidden' }"
		  >
		    <view
		      ...
		      <view
		        ...
		        :style="{
		          ...
		          flex: scroll ? '' : 1,
					height: '56rpx',
		          padding: paddingItem,
					background: current == i ? '#ffffff' : '',
					borderRadius: current == i ? '18rpx' : '0rpx',
		        }"
		        @click="change(i)"
		      >
		        {{ field ? v[field] : v }}
